...
class TaskDetailViewController: UIViewController {
    ...
    @IBAction func didTapAttachPhotoButton(_ sender: Any) {
        ...
        // If authorization denied, show alert with option to go to setting to update authorization.
...
extension TaskDetailViewController: MKMapViewDelegate {
    // Implement mapView(_:viewFor:) delegate mehtod.
    func mapView(_mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        // Cast the dequeued annotation view to your specific custom annotation view class, 'TaskAnnotatioView'
